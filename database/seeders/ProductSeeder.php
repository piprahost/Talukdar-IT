...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $brands = [
            ...
            ['name' => 'Acer', 'description' => 'Acer Incorporated', 'sort_order' => 5],
            ['name' => 'Samsung', 'description' => 'Samsung Electronics', 'sort_order' => 6],
            ['name' => 'Apple', 'description' => 'Apple Inc.', 'sort_order' => 7],
        ];
        ...
        $products = [
            ...
            ['name' => 'Canon PIXMA G3010', 'category' => 'Printers', 'brand' => null, 'model' => null, 'cost_price' => 15000, 'selling_price' => 20000, 'stock' => 18, 'sku' => 'CN-PIX-G30-001'],
