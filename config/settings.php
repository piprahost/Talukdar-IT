        ...
        'sms' => [
            ...
            'keys' => [
                ...
                'api_key' => [
                    'type' => 'text',
                    'label' => 'API Key',
                    'description' => 'API key from your SMS provider (SMSQ, Bangladesh SMS, SSL, Twilio, etc.).',
                    'default' => '',
                    'input_type' => 'password',
                    'show_for' => ['smsq', 'bangladeshsms', 'ssl', 'bulksmsbd', 'infobip', 'nexmo', 'twilio', 'other'],
                ],
                'api_secret' => [
                    'type' => 'text',
                    'label' => 'API Secret (optional)',
                    'description' => 'API secret if required by the provider (e.g. Twilio, Nexmo).',
                    'default' => '',
                    'input_type' => 'password',
                    'show_for' => ['twilio', 'nexmo', 'infobip', 'other'],
                ],
                'sender_id' => [
                    'type' => 'text',
                    'label' => 'Sender ID / Mask',
                    'description' => 'Sender name or mask approved by the provider (e.g. COMPANY). Used by SMSQ, Teletalk, Bangladesh SMS, etc.',
                    'default' => '',
                    'show_for' => ['smsq', 'bangladeshsms', 'teletalk', 'ssl', 'bulksmsbd', 'robi', 'gp', 'banglalink', 'robi_bulk', 'gp_bulk', 'other'],
                ],
                'username' => [
                    'type' => 'text',
                    'label' => 'Username',
                    'description' => 'Login username (Teletalk and some gateways).',
                    'default' => '',
                    'show_for' => ['teletalk', 'other'],
                ],
                'password' => [
                    'type' => 'text',
                    'label' => 'Password',
