        ...
        <div class="table-card">
            ...
            <div class="p-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="company_name" name="company_name" value="{{ old('company_name') }}" placeholder="Optional">
                </div>
                <div class="row">
        ...
        <div class="table-card">
            ...
            <div class="p-4">
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-primary"><i class="fas fa-save me-1"></i> Create Supplier</button>
