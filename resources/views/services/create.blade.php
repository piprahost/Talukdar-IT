    ...
    <div class="col-md-10 mx-auto">
        <div class="table-card">
            <div class="table-card-header">
                <h6><i class="fas fa-laptop-medical me-2"></i>Create New Service Order</h6>
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('product_name') is-invalid @enderror" id="product_name" name="product_name" value="{{ old('product_name') }}" placeholder="e.g., Laptop, Desktop, Printer" required>
                            @error('product_name')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('serial_number') is-invalid @enderror" id="serial_number" name="serial_number" value="{{ old('serial_number') }}" placeholder="Scan barcode here or enter manually" autofocus>
                            @error('serial_number')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control @error('problem_notes') is-invalid @enderror" id="problem_notes" name="problem_notes" rows="3" placeholder="Describe the problem reported by customer...">{{ old('problem_notes') }}</textarea>
                            @error('problem_notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control @error('service_notes') is-invalid @enderror" id="service_notes" name="service_notes" rows="3" placeholder="Service technician notes...">{{ old('service_notes') }}</textarea>
                            @error('service_notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" class="form-control @error('receive_date') is-invalid @enderror" id="receive_date" name="receive_date" value="{{ old('receive_date', date('Y-m-d')) }}" required>
                            @error('receive_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('service_cost') is-invalid @enderror" id="service_cost" name="service_cost" value="{{ old('service_cost', 0) }}" placeholder="0.00" required oninput="calculateDue()">
                            @error('service_cost')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control @error('customer_address') is-invalid @enderror" id="customer_address" name="customer_address" rows="2" placeholder="Customer address...">{{ old('customer_address') }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('paid_amount') is-invalid @enderror" id="paid_amount" name="paid_amount" value="{{ old('paid_amount', 0) }}" placeholder="0.00" required oninput="calculateDue()">
                            @error('paid_amount')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('due_amount') is-invalid @enderror" id="due_amount" name="due_amount" value="{{ old('due_amount', 0) }}" placeholder="0.00" readonly style="background-color: #f8f9fa;">
                            @error('due_amount')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control @error('internal_notes') is-invalid @enderror" id="internal_notes" name="internal_notes" rows="2" placeholder="Internal notes (not visible to customer)...">{{ old('internal_notes') }}</textarea>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const barcodeField = document.getElementById('serial_number');
    if (barcodeField) {
        // Focus after a small delay to ensure page is fully loaded
        setTimeout(function() {
            barcodeField.focus();
        }, 100);
