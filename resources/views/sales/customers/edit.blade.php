                ...
                <div class="p-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control" id="email" name="email" value="{{ old('email', $customer->email) }}" placeholder="email@example.com">
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="mobile" name="mobile" value="{{ old('mobile', $customer->mobile) }}">
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="address" class="form-label">Address</label>
                        <textarea class="form-control" id="address" name="address" rows="2" placeholder="Street, area">{{ old('address', $customer->address) }}</textarea>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="tax_id" name="tax_id" value="{{ old('tax_id', $customer->tax_id) }}" placeholder="Optional">
                    </div>
                </div>
        </div>
    </div>
        ...
        <div class="table-card">
            ...
            <div class="p-4">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="notes" name="notes" rows="3" placeholder="Internal notes">{{ old('notes', $customer->notes) }}</textarea>
                </div>
                <div class="mb-4">
