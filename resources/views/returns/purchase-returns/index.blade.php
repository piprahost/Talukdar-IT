...
<div class="table-card">
    <div class="table-card-header">
        <h6><i class="fas fa-undo me-2"></i>Purchase Returns</h6>
            ...
            <div class="row g-2 align-items-end">
                <div class="col-md-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" class="form-control" name="search" value="{{ request('search') }}" placeholder="Return #, PO number, supplier...">
                    </div>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-3 d-flex gap-2">
                    ...
                    <a href="{{ route('purchase-returns.index') }}" class="btn btn-sm btn-outline-secondary">Clear</a>
                    @endif
                </div>
            </div>
        </form>
        ...
        <table class="table table-hover mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('purchases.show', $return->purchase_id) }}" class="text-primary fw-semibold" style="font-size:13px;">
                            {{ $return->purchase->po_number }}
                        </a>
                    </td>
                    <td style="font-size:13px;">{{ $return->supplier->name }}</td>
                    ...
                    <td class="text-center">
                        <div class="btn-group btn-group-sm">
                            <a href="{{ route('purchase-returns.show', $return) }}" class="btn btn-outline-primary" title="View"><i class="fas fa-eye"></i></a>
                            @if($return->status === 'pending')
                            <a href="{{ route('purchase-returns.edit', $return) }}" class="btn btn-outline-warning" title="Edit"><i class="fas fa-edit"></i></a>
                            @endif
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="7" class="text-center py-5">
                        ...
                        <p class="text-muted">No purchase returns found.</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
