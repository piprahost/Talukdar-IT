        ...
        <table class="table table-hover">
            ...
            <tbody>
                @forelse($salesByProduct as $item)
                    <tr>
                        ...
                        <td class="text-end">৳{{ number_format($item->total_amount / max($item->total_quantity, 1), 2) }}</td>
                    </tr>
                @empty
            ...
            <tfoot>
                <tr class="table-secondary">
                    ...
                    <th class="text-end">{{ number_format($salesByProduct->sum('total_quantity')) }}</th>
                    <th class="text-end">৳{{ number_format($salesByProduct->sum('total_amount'), 2) }}</th>
                    <th></th>
                </tr>
            </tfoot>
            @endif
