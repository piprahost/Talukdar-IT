...
<div class="table-card">
    <div class="table-card-header">
        <h6><i class="fas fa-tags me-2"></i>Sales by Category</h6>
    ...
    <div class="table-responsive p-4">
        <table class="table table-hover">
            ...
            <tbody>
                @php
                    $grandTotal = $salesByCategory->sum('total_amount');
                @endphp
            ...
            <tfoot>
                <tr class="table-secondary">
                    <th>Total</th>
                    <th class="text-end">{{ number_format($salesByCategory->sum('total_quantity')) }}</th>
