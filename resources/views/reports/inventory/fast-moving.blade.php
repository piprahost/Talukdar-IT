...
@section('page-title', 'Fast Moving Products')

@section('content')
<div class="table-card">
    <div class="table-card-header">
        <h6><i class="fas fa-rocket me-2"></i>Fast Moving Products</h6>
        ...
        <table class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-end">Number of Sales</th>
            ...
            <tbody>
                @forelse($fastMoving as $index => $item)
                    <tr>
                        ...
                        <td class="text-end"><strong>{{ number_format($item->total_sold) }}</strong></td>
                        <td class="text-end"><span class="badge bg-info">{{ $item->sale_count }}</span></td>
                        <td class="text-end">{{ number_format($item->total_sold / max($item->sale_count, 1), 1) }}</td>
                    </tr>
                @empty
