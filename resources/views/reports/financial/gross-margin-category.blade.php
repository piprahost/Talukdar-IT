...
@section('title', 'Gross Margin by Category')
@section('page-title', 'Gross Margin by Category')

@section('content')
<div class="table-card">
    <div class="table-card-header">
        <h6><i class="fas fa-percentage me-2"></i>Gross Margin Analysis by Category</h6>
    ...
    <div class="table-responsive p-4">
        <table class="table table-hover">
            ...
            <tbody>
                @forelse($marginByCategory as $item)
                    <tr>
                ...
                @empty
                    <tr><td colspan="6" class="text-center">No margin data found.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
